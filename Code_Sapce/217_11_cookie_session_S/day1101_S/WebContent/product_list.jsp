<%@page import="com.dj.web.utils.CookieUtils"%>
...
<html>
	...
	<body>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<div class="col-md-2">
				<a href="/day1101_S/getProductById?id=1">
					<img src="products/1/cs10001.jpg" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="/day1101_S/getProductById?id=1" style='color:green'>衣服1</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>

			<div class="col-md-2">
				<a href="/day1101_S/getProductById?id=2">
					<img src="products/1/cs10002.jpg" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="product_info.html" style='color:green'>衣服2</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>

			<div class="col-md-2">
				<a href="/day1101_S/getProductById?id=3">
					<img src="products/1/cs10003.jpg" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="product_info.html" style='color:green'>衣服3</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>

			<div class="col-md-2">
				<a href="/day1101_S/getProductById?id=4">
					<img src="products/1/cs10004.jpg" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="product_info.html" style='color:green'>衣服4</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>
			<div class="col-md-2">
				<a href="/day1101_S/getProductById?id=5">
					<img src="products/1/cs10005.jpg" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="product_info.html" style='color:green'>衣服5</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>

			<div class="col-md-2">
				<a href="/day1101_S/getProductById?id=6">
					<img src="products/1/cs10006.jpg" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="product_info.html" style='color:green'>衣服6</a></p>
				<p><font color="#FF0000">商城价：&yen;299.00</font></p>
			</div>
		...
		<div style="width:1210px;margin:0 auto; padding: 0 9px;border: 1px solid #ddd;border-top: 2px solid #999;height: 246px;">
			...
			<h4 style="width: 50%;float: left;font: 14px/30px " 微软雅黑 ";">浏览记录<small><a href="/day1101_S/clearHistory">清空</a></small></h4>
